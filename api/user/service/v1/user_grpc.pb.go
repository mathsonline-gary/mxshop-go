...
func (c *userServiceClient) GetUserByEmail(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*UserInfoResponse, error) {
	out := new(UserInfoResponse)
...
func (UnimplementedUserServiceServer) GetUserByEmail(context.Context, *EmailRequest) (*UserInfoResponse, error) {
